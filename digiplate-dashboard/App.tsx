...
import { doc, getDoc, setDoc, collection, query, where, onSnapshot, getDocs, deleteDoc } from 'firebase/firestore';
...
export type Page = 'Dashboard' | 'Menus' | 'Orders' | 'Floor Plan' | 'Inventory' | 'Stores' | 'Settings';
...
const App: React.FC = () => {
  ...
  const renderAdminPage = () => {
    ...
    switch(activePage) {
      ...
      case 'Floor Plan':
        return <FloorPlanPage {...pageProps} profile={profile} />;
      case 'Inventory':
