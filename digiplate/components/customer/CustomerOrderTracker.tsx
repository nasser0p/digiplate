    ...
    return (
        <div className="bg-white dark:bg-brand-gray-800 p-5 rounded-2xl shadow-lg border border-brand-gray-200 dark:border-brand-gray-700">
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h3 className="font-bold text-lg text-brand-gray-800 dark:text-white">Plate: {order.plateNumber}</h3>
            ...
            {order.status === 'Completed' ? (
                <div className="flex items-center gap-3 text-green-600 dark:text-green-400">
                    ...
                    <span className="font-bold text-lg">Order Completed! Enjoy!</span>
                </div>
            ) : (
