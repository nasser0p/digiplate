                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                         ...
                         <div className="flex justify-between mt-8">
                            ...
                            <button type="button" onClick={handleNext} disabled={!formData.restaurantName || !formData.restaurantType || formData.languages.length === 0} className="bg-brand-teal text-white font-bold py-2 px-4 rounded-lg hover:bg-brand-teal-dark disabled:bg-teal-300">{t('common_next')}</button>
                        </div>
                    </div>
                );
            case 3:
