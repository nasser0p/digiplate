...
const CustomerItemRow: React.FC<CustomerItemRowProps> = ({ item, onSelectItem, promotion }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-grow min-w-0">
                ...
                <p className="font-bold text-brand-customer mt-2 text-md">OMR {item.price.toFixed(3)}</p>
            </div>
