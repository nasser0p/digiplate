...
const CustomerItemCard: React.FC<CustomerItemCardProps> = ({ item, onSelectItem, promotion }) => {
    ...
    return (
        <div 
            ...
            className={`
                ...
                ${item.isAvailable ? 'hover:shadow-xl hover:scale-[1.02] cursor-pointer' : 'opacity-60 cursor-not-allowed'}
            `}
        >
            ...
            <div className="relative">
                ...
                {/* Price Badge */}
                <div className="absolute top-3 right-3 bg-brand-customer text-white font-bold text-lg py-1 px-3 rounded-full shadow-lg pointer-events-none">
